        ...
        <div id='features'>
            <div className='z-container'>
                <div className='a-container'>
                    ...
                    <button className='sports'> <Link to="/sports" >CICK ME</Link> </button>
                    <FacilitiesBox image={featureimage1} title='Restaurant' />
                    <button className='restaurant'> <Link to="/restaurant" >CICK ME</Link> </button>
                    <FacilitiesBox image={featureimage2} title='Cinema' />
                    <button className='cinema'> <Link to="/cinema" >CICK ME</Link> </button>
                </div>
                <div className='a-container'>
                    <FacilitiesBox image={featureimage3} title='Banking System' />
                    <button className='banking'> <Link to="/banking" >CICK ME</Link> </button>
                    <FacilitiesBox image={featureimage4} title='Theme Park' />
                    <button className='theme'> <Link to="/theme" >CICK ME</Link> </button>
                    <FacilitiesBox image={featureimage5} title='Hotel Management' />
                    <button className='hotel'> <Link to="/hotel" >CICK ME</Link> </button>
                </div>
                <div className='a-container'>
                    <FacilitiesBox image={featureimage6} title='Health Care' />
                    <button className='health'> <Link to="/health" >CICK ME</Link> </button>
                    <FacilitiesBox image={featureimage7} title='Gym Management' />
                    <button className='gym'> <Link to="/gym" >CICK ME</Link> </button>
                </div>
            </div>
        </div>
        <Footer/>
