...
export default function UpdateAppointment() {
    ...
    const getAApp = (id) =>{
        axios.get(`${SERVER_URL}/appointment/${id}`).then(res =>{
    ...
    useEffect(()=>{getAApp(id)},[])


    const handleSubmit = async (event) => {
        event.preventDefault();
        //const docname = doctor.name;
        setApptDate(moment(ApptDate).format());

        // const newAppnt = {docname, Patient,phone,email,age,gender,ApptDate};
        //
